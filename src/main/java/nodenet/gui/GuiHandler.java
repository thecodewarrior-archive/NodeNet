...
import nodenet.gui.nodemanipulator.GuiNodeConfItem;
import nodenet.gui.nodemanipulator.NodeConfItemContainer;
...
public class GuiHandler implements IGuiHandler {
	...
	public GuiHandler() {
        NetworkRegistry.INSTANCE.registerGuiHandler(NodeNet.INSTANCE, this);
