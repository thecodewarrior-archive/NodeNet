...
import nodenet.render.ShaderCallback;
...
public class RenderNode extends Render<EntityNodeBase> {
	...
	public void doRender(EntityNodeBase entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if(NodeClient.getSel() == entity && GeneralUtil.isHolding(Minecraft.getMinecraft().thePlayer, (stack) -> stack.getItem() == ItemRegister.nodeManipulator)) {
