...
public final class ShaderHelper implements IResourceManagerReloadListener {
	...
	public static void initShaders() {
		...
		ring = createProgram(null, "/assets/nodenet/shader/ring.frag");
		if(Const.developmentEnvironment && Minecraft.getMinecraft().getResourceManager() instanceof IReloadableResourceManager)
